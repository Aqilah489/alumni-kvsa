...
$page_css = 'alumni'; // Guna alumni.css
$error = '';
$success = '';

// Get user info
$stmt = $connect->prepare("SELECT nama, emel FROM kaunseling WHERE kaunseling_id = ?");
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $connect->prepare("SELECT password FROM kaunseling WHERE kaunseling_id = ?");
    $stmt->execute([$_SESSION['user_id']]);
    $current = $stmt->fetch();
    ...
    if(!password_verify($password_lama, $current['password'])) {
        ...
        $stmt = $connect->prepare("UPDATE kaunseling SET password = ? WHERE kaunseling_id = ?");
        ...
        <div class="form-body">
            ...
            <div class="info-user">
                ...
                <div class="info-user-badge">
                    <span class="badge-role">Kaunseling</span>
                </div>
            </div>
            ...
            <form method="POST" id="passwordForm">
                ...
                <div class="form-actions">
                    <a href="dashboard_kaunseling.php" class="btn-back">
